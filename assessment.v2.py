...
while rounds_played < num_rounds:
    ...
    user_choice = int_check(f"\n What is the answer?? (no decimals): ")
    ...
    guess = ""
    while (guess != answer and guesses_used < guesses_allowed):
        ...
        if guess in already_guessed:
            print(input(f"You've already guessed {guess}. You've *still* used "
        ...
        # options (lucky / 'phew' / well done)
            ...
            if guesses_used == 1:
                feedback = " Nice! You got it on your first try. "
            elif guesses_used == guesses_allowed:
                feedback = f"Phew! You got it in {guesses_used} tries."
            else:
                feedback = f"Well Done! You got the answer in {guesses_used} tries."
